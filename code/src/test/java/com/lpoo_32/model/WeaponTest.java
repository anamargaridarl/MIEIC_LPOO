...
public class WeaponTest {
    ...
    @Test
    public void interact() throws OutOfBoundaries, HungerOVF, HealthOVF, ThirstOVF, HungerRestored, ThirstRestored {
        PlayerModel player = new PlayerModel(new Position(4,5, Game.width/4, Game.height/4, 0));
        Screen screen = Mockito.mock(Screen.class);
        GameController gameController = new GameController(new DisplayProps(screen),new Elements(),player);
